...
class RunText(SampleBase):
    def __init__(self, *args, **kwargs):
        ...
        self.parser.add_argument("-t", "--text", help="The text to scroll on the RGB LED panel", default=AllUptown())
    ...
    def run(self):
        ...
        while True:
            ...
            len = graphics.DrawText(offscreen_canvas, font, pos, 30, textColor, text2)
